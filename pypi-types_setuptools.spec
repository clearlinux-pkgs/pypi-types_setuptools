...
Source0  : https://files.pythonhosted.org/packages/9e/08/99563df1520cbea98ba0d9c2384d44f4b324092d7aeb99899b7455a9aafb/types-setuptools-67.6.0.0.tar.gz
...
%prep
%setup -q -n types-setuptools-67.6.0.0
cd %{_builddir}/types-setuptools-67.6.0.0
pushd ..
cp -a types-setuptools-67.6.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678467822
