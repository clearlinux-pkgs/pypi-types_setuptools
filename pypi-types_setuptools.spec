...
Source0  : https://files.pythonhosted.org/packages/fa/80/d9f62767f364cc51f386034f16035ea33779937fb44bfd82dadc00adf691/types-setuptools-57.4.8.tar.gz
...
%prep
%setup -q -n types-setuptools-57.4.8
cd %{_builddir}/types-setuptools-57.4.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643584828
