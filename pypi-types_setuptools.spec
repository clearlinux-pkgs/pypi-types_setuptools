...
Source0  : https://files.pythonhosted.org/packages/c3/20/794589df23b1e7d3c1a1f86285e749f2a83ef845d90f2461bc2912b8f989/types_setuptools-75.8.0.20250210.tar.gz
...
%prep
%setup -q -n types_setuptools-75.8.0.20250210
cd %{_builddir}/types_setuptools-75.8.0.20250210
pushd ..
cp -a types_setuptools-75.8.0.20250210 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739207185
