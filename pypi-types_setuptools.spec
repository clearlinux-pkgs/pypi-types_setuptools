...
Source0  : https://files.pythonhosted.org/packages/2c/c9/63a09a2eaf9d37538fc885ffc25829f76956d3dc281238439e0d5b4ac910/types-setuptools-65.5.0.1.tar.gz
...
%prep
%setup -q -n types-setuptools-65.5.0.1
cd %{_builddir}/types-setuptools-65.5.0.1
pushd ..
cp -a types-setuptools-65.5.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666020847
