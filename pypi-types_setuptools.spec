...
Source0  : https://files.pythonhosted.org/packages/1f/32/ad55729b96c07993bbf83a0a734a3ee8402ea42268939aeae30c4f3600d0/types-setuptools-68.2.0.0.tar.gz
...
%prep
%setup -q -n types-setuptools-68.2.0.0
cd %{_builddir}/types-setuptools-68.2.0.0
pushd ..
cp -a types-setuptools-68.2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694101714
