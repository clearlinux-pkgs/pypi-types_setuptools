...
Source0  : https://files.pythonhosted.org/packages/4f/4b/fadfbd0cbaa6ae3cc22812e5d941086a4d136ff4941dfce8611390c96505/types-setuptools-57.4.15.tar.gz
...
%prep
%setup -q -n types-setuptools-57.4.15
cd %{_builddir}/types-setuptools-57.4.15
pushd ..
cp -a types-setuptools-57.4.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653341553
