...
Source0  : https://files.pythonhosted.org/packages/58/98/669c6f7069f19c1a4d940926dc66ca840a28bf969e52cfbc5dd239a53a19/types-setuptools-63.2.0.tar.gz
...
%prep
%setup -q -n types-setuptools-63.2.0
cd %{_builddir}/types-setuptools-63.2.0
pushd ..
cp -a types-setuptools-63.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657895402
