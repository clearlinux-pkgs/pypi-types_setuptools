...
Source0  : https://files.pythonhosted.org/packages/18/04/4533bb7506e98ffd02c8fe6d41eeab1e49e2396f0982908e7767b9e478af/types-setuptools-65.7.0.3.tar.gz
...
%prep
%setup -q -n types-setuptools-65.7.0.3
cd %{_builddir}/types-setuptools-65.7.0.3
pushd ..
cp -a types-setuptools-65.7.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674150308
