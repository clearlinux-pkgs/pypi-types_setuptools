...
Source0  : https://files.pythonhosted.org/packages/a7/b3/19bc83fe656d60591b428a12fbff3b72f8a619fc0f410f6bfb110b167d69/types-setuptools-68.1.0.1.tar.gz
...
%prep
%setup -q -n types-setuptools-68.1.0.1
cd %{_builddir}/types-setuptools-68.1.0.1
pushd ..
cp -a types-setuptools-68.1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693442759
