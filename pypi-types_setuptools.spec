...
Source0  : https://files.pythonhosted.org/packages/80/bd/5e02b6ad8595bbfe5a7967e016a8858ffae384413e51ec489e5997900d79/types-setuptools-65.3.0.tar.gz
...
%prep
%setup -q -n types-setuptools-65.3.0
cd %{_builddir}/types-setuptools-65.3.0
pushd ..
cp -a types-setuptools-65.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661533414
