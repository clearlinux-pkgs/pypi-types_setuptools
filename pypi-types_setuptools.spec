...
Source0  : https://files.pythonhosted.org/packages/33/d2/d51f630222844d3d39dc80cb7f34f3df1765ee2ffed22f9b82e111afe1cc/types-setuptools-69.0.0.20240125.tar.gz
...
%prep
%setup -q -n types-setuptools-69.0.0.20240125
cd %{_builddir}/types-setuptools-69.0.0.20240125
pushd ..
cp -a types-setuptools-69.0.0.20240125 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706201713
