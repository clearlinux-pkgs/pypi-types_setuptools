...
Source0  : https://files.pythonhosted.org/packages/d0/e0/c551d49faedf9db1b4c4e061e90ac258189f0f6bfb7f3ade3a1cba20296a/types-setuptools-67.2.0.1.tar.gz
...
%prep
%setup -q -n types-setuptools-67.2.0.1
cd %{_builddir}/types-setuptools-67.2.0.1
pushd ..
cp -a types-setuptools-67.2.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676045888
