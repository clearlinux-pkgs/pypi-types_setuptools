...
Source0  : https://files.pythonhosted.org/packages/79/66/1b276526aad4696a9519919e637801f2c103419d2c248a6feb2729e034d1/types_setuptools-80.9.0.20250529.tar.gz
...
%prep
%setup -q -n types_setuptools-80.9.0.20250529
cd %{_builddir}/types_setuptools-80.9.0.20250529
pushd ..
cp -a types_setuptools-80.9.0.20250529 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748521634
