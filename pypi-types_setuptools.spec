...
Source0  : https://files.pythonhosted.org/packages/78/89/081fb601a795995d0032d024bc71bf0a0c835a566f06c18c88a220f950e5/types-setuptools-70.3.0.20240710.tar.gz
...
%prep
%setup -q -n types-setuptools-70.3.0.20240710
cd %{_builddir}/types-setuptools-70.3.0.20240710
pushd ..
cp -a types-setuptools-70.3.0.20240710 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720644520
