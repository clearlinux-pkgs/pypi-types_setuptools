...
Source0  : https://files.pythonhosted.org/packages/e9/6e/c54e6705e5fe67c3606e4c7c91123ecf10d7e1e6d7a9c11b52970cf2196c/types_setuptools-78.1.0.20250329.tar.gz
...
%prep
%setup -q -n types_setuptools-78.1.0.20250329
cd %{_builddir}/types_setuptools-78.1.0.20250329
pushd ..
cp -a types_setuptools-78.1.0.20250329 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743431853
