...
Source0  : https://files.pythonhosted.org/packages/62/d0/7df9c20c727fc4c9cc4b389dee6f429ef6bed4604677885029d3c6d70ab5/types-setuptools-67.3.0.1.tar.gz
...
%prep
%setup -q -n types-setuptools-67.3.0.1
cd %{_builddir}/types-setuptools-67.3.0.1
pushd ..
cp -a types-setuptools-67.3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676476644
