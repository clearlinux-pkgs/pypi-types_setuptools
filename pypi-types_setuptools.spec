...
Source0  : https://files.pythonhosted.org/packages/b8/3e/9e04e5d992e439cd791d0960185dd8704f2f53a7c84acad3a0e87fc6b4f6/types-setuptools-67.4.0.3.tar.gz
...
%prep
%setup -q -n types-setuptools-67.4.0.3
cd %{_builddir}/types-setuptools-67.4.0.3
pushd ..
cp -a types-setuptools-67.4.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677516684
