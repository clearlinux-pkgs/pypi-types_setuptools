...
Source0  : https://files.pythonhosted.org/packages/40/55/1e0c9c664303e5d301f113de11bfa639bf8d121451c7688a07c3711dbc16/types-setuptools-65.4.0.0.tar.gz
...
%prep
%setup -q -n types-setuptools-65.4.0.0
cd %{_builddir}/types-setuptools-65.4.0.0
pushd ..
cp -a types-setuptools-65.4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664556868
