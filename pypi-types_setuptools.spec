...
Source0  : https://files.pythonhosted.org/packages/f7/42/5713e90d4f9683f2301d900f33e4fc2405ad8ac224dda30f6cb7f4cd215b/types_setuptools-75.8.0.20250110.tar.gz
...
%prep
%setup -q -n types_setuptools-75.8.0.20250110
cd %{_builddir}/types_setuptools-75.8.0.20250110
pushd ..
cp -a types_setuptools-75.8.0.20250110 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736521681
