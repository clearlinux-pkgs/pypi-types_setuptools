...
Source0  : https://files.pythonhosted.org/packages/77/29/677f2abc5f8ee0e9d9141a51884dfd7d4941d258762843c48805558f8d83/types-setuptools-70.1.0.20240625.tar.gz
...
%prep
%setup -q -n types-setuptools-70.1.0.20240625
cd %{_builddir}/types-setuptools-70.1.0.20240625
pushd ..
cp -a types-setuptools-70.1.0.20240625 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719330835
