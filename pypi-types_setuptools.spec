...
Source0  : https://files.pythonhosted.org/packages/a6/29/06aa5ec0160bf5f5a69c5be251b7a0f6ed7491186d27eab11c371a943120/types-setuptools-65.6.0.0.tar.gz
...
%prep
%setup -q -n types-setuptools-65.6.0.0
cd %{_builddir}/types-setuptools-65.6.0.0
pushd ..
cp -a types-setuptools-65.6.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669055950
