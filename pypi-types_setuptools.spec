...
Source0  : https://files.pythonhosted.org/packages/13/5e/3d46cd143913bd51dde973cd23b1d412de9662b08a3b8c213f26b265e6f1/types-setuptools-57.4.18.tar.gz
...
%prep
%setup -q -n types-setuptools-57.4.18
cd %{_builddir}/types-setuptools-57.4.18
pushd ..
cp -a types-setuptools-57.4.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656344417
