...
%prep
%setup -q -n types-setuptools-75.2.0.20241025
cd %{_builddir}/types-setuptools-75.2.0.20241025
pushd ..
cp -a types-setuptools-75.2.0.20241025 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729867844
