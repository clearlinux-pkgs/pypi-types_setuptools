...
Source0  : https://files.pythonhosted.org/packages/42/2e/d21d995feca499eac401958fee97879926249e60b8e5608f0361f0ee2ae1/types-setuptools-57.4.14.tar.gz
...
%prep
%setup -q -n types-setuptools-57.4.14
cd %{_builddir}/types-setuptools-57.4.14
pushd ..
cp -a types-setuptools-57.4.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653009001
