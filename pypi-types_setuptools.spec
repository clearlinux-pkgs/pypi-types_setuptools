...
Source0  : https://files.pythonhosted.org/packages/4a/cf/efee0a144d93e4c53a24555740c353b6b75b220aed9d35f7c2c0a0644ee2/types-setuptools-57.4.7.tar.gz
...
%prep
%setup -q -n types-setuptools-57.4.7
cd %{_builddir}/types-setuptools-57.4.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641945122
